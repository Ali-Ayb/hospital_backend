...
$user_type_id = $link->prepare('SELECT id FROM medications WHERE name = ? ');
...
$user_type_id = $link->prepare('Insert INTO user_departments (user_id, medicatoin_id, quantity) Value (?,?,?)');
